...
function getRecipesFromStorage() {
  ...
  let localObject = localStorage.getItem('recipes');
...
function saveRecipesToStorage(recipes) {
  ...
  //            be no more than a few lines.
  /*
  let initialArr = JSON.parse(localStorage.getItem('recipes'));
  initialArr[initialArr.length] = recipes;
...
function initFormHandler() {
  ...
  myForm.addEventListener('submit', () =>{
    ...
    let initialArr = JSON.parse(localStorage.getItem('recipes'));
    initialArr[initialArr.length] = recipeObject;
    localStorage.setItem('recipe', initialArr);
  });
